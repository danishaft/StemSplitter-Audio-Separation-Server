...
**Goal:** Transform from 7 stems (5 pro, 2 DSP) → **16 pro-standard stems** using MVSEP + Demucs model chaining.
...
StemSplitter now supports **16 pro-standard stems** using MVSEP + Demucs model chaining:
